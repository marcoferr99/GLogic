...
\begin{gather*}
    ...
    \inflab{
        \sequent{
            ...
            \judgement{
                \listdelim{T_{\length{\Sigma} + 1} \listsep \dots \listsep T_n}
            }{
                \subst{s}{n+1}{0 \listsep \dots \listsep \length{\Sigma}-1 \listsep \length{\Sigma}+1 \listsep \dots \listsep n \listsep \tmapp{\tmapp{\tmapp{\length{\Sigma}}{(\length{\Sigma}+1)}}{\dots}}{n}}
            }
        }
    }{
